...
<body>
<!--Show Possible Errors or Success proceed registration-->
    <?php
    if($showAlert) {
        echo ' <div class="alert alert-success 
                alert-dismissible fade show" role="alert">        
                <strong>Success!</strong> Your account is 
                created and you can Log in. 
    ...
    <div class="container my-4 ">
        ...
        <form action="index.php" method="post" class="form-signin mt-5 py-4 w-25 m-auto">
        ...
        <form class="form-signin mt-2 py-4 w-25 m-auto">
            <p class="text-center">Have an account?   <a href="auth/login.php">Log in</a></p>
        </form>
    </div>
